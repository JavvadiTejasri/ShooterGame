...
public class PlayerMovement : MonoBehaviour
{
    ...
    {
        if (Input.GetKeyDown(KeyCode.LeftArrow) && transform.position.x>=-11.4f)
            transform.Translate(-speedOfPlayer, 0, 0);
        else if(Input.GetKeyDown(KeyCode.RightArrow) && transform.position.x <= 10.4f)
            transform.Translate(speedOfPlayer, 0, 0);
        else if (Input.GetKeyDown(KeyCode.UpArrow) && transform.position.y <= 4.0f)
            transform.Translate(0,speedOfPlayer, 0, 0);
